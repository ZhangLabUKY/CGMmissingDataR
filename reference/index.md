...
- [`run_missingness_benchmark()`](https://zhanglabuky.github.io/CGMmissingDataR/reference/run_missingness_benchmark.md)
  **\[deprecated\]** : Run missingness benchmark (target-masking with
  LAG features)

## Datasets

- [`CGMExmplDat5Pct`](https://zhanglabuky.github.io/CGMmissingDataR/reference/CGMExmplDat5Pct.md)
  : Example dataset for CGMissingData
- [`CGMExmplDat10Pct`](https://zhanglabuky.github.io/CGMmissingDataR/reference/CGMExmplDat10Pct.md)
  : Example dataset for CGMissingData
